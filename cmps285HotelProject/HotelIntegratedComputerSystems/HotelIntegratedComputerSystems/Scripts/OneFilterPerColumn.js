...
function filterFunctionColumn4(tableName) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(1, filter2, tableRow[i]);
        checkForfilter(2, filter3, tableRow[i]);
        checkForfilter(3, filter4, tableRow[i]);
    }
}
...
function filterFunctionColumn5(tableName) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(2, filter3, tableRow[i]);
        checkForfilter(3, filter4, tableRow[i]);
        checkForfilter(4, filter5, tableRow[i]);
    }
}
...
function filterFunctionColumn6(tableName) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(3, filter4, tableRow[i]);
        checkForfilter(4, filter5, tableRow[i]);
        checkForfilter(5, filter6, tableRow[i]);
    }
}
...
function filterFunctionColumn7(tableName) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(4, filter5, tableRow[i]);
        checkForfilter(5, filter6, tableRow[i]);
        checkForfilter(6, filter7, tableRow[i]);
    }
}
...
function filterFunctionColumn8(tableName) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(5, filter6, tableRow[i]);
        checkForfilter(6, filter7, tableRow[i]);
        checkForfilter(7, filter8, tableRow[i]);
    }
}
...
function filterFunctionColumn9(tableName) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(6, filter7, tableRow[i]);
        checkForfilter(7, filter8, tableRow[i]);
        checkForfilter(8, filter9, tableRow[i]);
    }
}
...
function filterFunctionColumn10(tableName, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10) {
    ...
    for (var i = 0; i < tableRow.length; i++) {
        ...
        checkForfilter(7, filter8, tableRow[i]);
        checkForfilter(8, filter9, tableRow[i]);
        checkForfilter(9, filter10, tableRow[i]);
    }
}
...
function checkForfilter(column, filter, tableRow) {
    if (filter != "") {
        FilterTheColumn(column, filter, tableRow);
    }
}

function FilterTheColumn(columnIndex, filter, tableRow) {
    var column = tableRow.getElementsByTagName("td")[columnIndex];

    if (column) {
        if ((column.innerHTML.toUpperCase().indexOf(filter) > -1) && (tableRow.style.display == "")) {
            tableRow.style.display = "";
        }
        else if ((column.innerHTML.toUpperCase().indexOf(filter) > -1) && (tableRow.style.display == "none")) {
        }
        else {
